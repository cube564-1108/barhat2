...
# На сколько кнопка «Я еду» отодвигает сгорание брони. Одно продление на бронь
# (решение владельца 19.09.2026): смысл сгорания — успеть отдать заказ другому
# курьеру, и бесконечное продление его отменяет.
CLAIM_EXTEND_MINUTES = 30
