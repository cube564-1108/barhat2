...
# Рядом в таблице стоит плановый интервал в стенных часах салона — факт обязан
# быть в той же шкале, иначе «план 12:00–14:00, факт 09:30» читается как
# «привезли раньше срока».
check("факт доставки отдан в часах салона, а не в UTC",
      data["late_orders"][0]["delivered_local"] == "14:30",
      f"({data['late_orders'][0]['delivered_local']})")
